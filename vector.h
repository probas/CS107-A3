...
#define DEFAULT_ALLOCATION_NUM  10
...
typedef struct {
  ...
  size_t maxSz;    // aka capacity, aka logical length. Expressed in number elements the vector can hold with current memory allocation
  size_t elemSz;
